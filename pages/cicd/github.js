...
export default () => (
  <Layout>
    ...
    <p>
      برای راه اندازی CI/CD در GitHub شما به GitHub Actions نیاز دارید. از{" "}
    ...
    <p>
      <b>گام اول)</b> در ابتدا نیاز دارید که در ریشه پروژه‌ی‌تان دایرکتوری
      ...
      liara.yaml را برای دپلوی در لیارا در نظر گرفته اید:
    </p>
...
`}
    ...
    <Notice variant="info">
      ...
      فایل بالا ما فقط ابزار liara cli را ابتدا نصب کرده‌ایم و سپس در ریشه پروژه
      دستور deploy را اجرا کرده‌ایم. در همین فایل میشود Test ها را اجرا کرد و
      مطمئن شد که پروژه‌ی ما سالم است و اجازه آپدیت شدن دارد. GitHub Actions
      امکانات بسیار خوبی برای CI/CD دارد و توصیه میکنیم حتما مستندات آن را
      مطالعه کنید.
    </Notice>
    <p>

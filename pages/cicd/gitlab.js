...
export default () => (
  <Layout>
    ...
    <p>
      <b>گام اول)</b> شما ابتدا نیاز دارید که فایلی تحت عنوان{" "}
...
`}
    ...
    <Notice variant="info">
      ...
      مطمئن شد که پروژه‌ی ما سالم است و اجازه آپدیت شدن دارد. GitLab CI امکانات
      بسیار خوبی برای CI/CD دارد و توصیه میکنیم حتما مستندات آن را مطالعه کنید.
    </Notice>
    <p>

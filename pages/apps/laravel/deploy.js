...
export default () => (
  <Layout>
    ...
    <p>
      ...
      برای پروژه تست‌مون، شناسه laravel-starter را انتخاب کردیم.
    </p>
    <p>
    ...
    <Notice variant="info">
      میتوانید <span className="code">--platform=laravel</span> را در دستور وارد
    ...
    <Link href="/apps/laravel/envs">متوجه شدم، برو بعدی!</Link>
  </Layout>
);
